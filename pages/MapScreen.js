...
const MapScreen = ({ navigation }) => {
    ...
    for (const report of floodReports) {
      if (report.severityLevel === "Severo") {
        ...
        if (distance <= 500) {
          ...
          // No break aquí, para que si hay varios reportes severos cerca, se alerten todos una sola vez
        }
      }
    }
  ...
  // Ejecuta la verificación cada vez que cambie la ubicación o los reportes
  useEffect(() => {
